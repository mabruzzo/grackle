...
)
{
  ...
  if (pack.local_edot_handling == 1)  {
    my_local_iter = 1;   // <-- this is a hacky bugfix
     FORTRAN_NAME(cool1d_multi_g)(
              ...
              &local_k, &my_chemistry->ih2co, &my_chemistry->ipiht, &my_local_iter, &my_chemistry->photoelectric_heating,
  ...
  //   of temperature.
   ...
   FORTRAN_NAME(lookup_cool_rates1d_g)(&my_chemistry->TemperatureStart, &my_chemistry->TemperatureEnd, &my_chemistry->NumberOfTemperatureBins,
            ...
            &pack.fwd_args.dom, &internalu.coolunit, &internalu.tbase1, &internalu.uxyz, &internalu.xbase1, &pack.fwd_args.dx_cgs,
            &pack.fwd_args.c_ljeans,
